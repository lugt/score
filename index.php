...
<body class="color-animate">
	...
	<div class="main">
		<div class="container">
			<h1 class="left-bottom-bar corner-bar bar-grass" style="margin-bottom: 0.7em;">教育智能 <mark style="    font-size: 0.5em;    padding-top: 0px;    vertical-align: top;    background: #b7d491;
    color: #fff;">Beta</mark></h1>
			<div class="row3">
				<div id="horizontalTabMain" style="display: block; width: 100%; margin: 0px;">
					<ul class="resp-tabs-list">
						<li class="bubble resp-tab-item resp-tab-active right-3" style="width: 30%; float:none;" aria-controls="tab_item-M" role="tab"> 教师入口</li>
						<li class="bubble resp-tab-item right-3" style="width: 30%; float:none;" aria-controls="tab_item-C" role="tab" > 学生入口 </li>
						<li class="bubble resp-tab-item" style="width: 30%; float:none;" aria-controls="tab_item-F" role="tab" > 家长入口 </li>
					</ul>
					...
					<div class="resp-tabs-container">
						<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-M">
							...
							<div class="col-md-7 col-sm-12 sm-nopadding">
								<div class="tab-bottom sm-prelap">
									...
									<div class="login-top" style="box-shadow: 1px 10px 30px #aaaaaa99;padding-bottom: 3em;border-bottom-left-radius: 15px;border-bottom-right-radius: 15px;">
						...
						<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-C">
							...
							<div class="col-md-7">
								<div class="tab-bottom sm-prelap" >
									<h4>无法登陆？ </h4>
									<p> 请联系班主任协助恢复密码。<br>在线客服：<a href="https://wx.qq.com" style="color:#FFDF71">戳这里进入</a> </p>
								</div>
								<div class="login-top" style="box-shadow: 1px 10px 30px #aaaaaa99; padding-bottom: 3em;border-bottom-left-radius: 15px;border-bottom-right-radius: 15px;">
							...
							<div class="panel panel-default">
								<div class="panel-heading" id="headingOne">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
										<h4 class="panel-title">行政消息</h4> <h6>今天</h6> <span class="glyphicon glyphicon-menu-down"></span>
									</a>
								</div>
								...
								<div id="collapseFive" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingFive">
									<div class="panel-body">
										...
										<div class="request-right">
											...
											<h6>教务领导</h6>
											<ul>
												<li><a href="#"><span class="glyphicon glyphicon-asterisk"></span> 360</a></li> 
												<li><a href="#"><span class="glyphicon glyphicon-envelope"></span> 72</a></li>
											</ul>
										</div>
										<div class="clearfix"></div>
									</div>
